...
### dataset
- some used KITTI datasets, which are representable
```
one car in the field of view: 
  kitti_03：frame46-85
```
```
dynamic:
  kitti_05：frame2286-2640
  kitti_07: frame625-680
```
```
dynamic and static： kitti12:930-end
```
### rgbd
```
<!-- evaluate文件夹下的用法不一样 -->
python2 YOUR_PATH/rgbd_dataset_freiburg3_nostructure_texture_far/associate.py rgb.txt depth.txt  > association.txt

./Examples/RGB-D/rgbd_tum Vocabulary/ORBvoc.txt Examples/RGB-D/TUM3.yaml YOUR_PATH/rgbd_dataset_freiburg3_walking_xyz YOUR_PATH/rgbd_dataset_freiburg3_walking_xyz/association.txt
./Examples/RGB-D/rgbd_tum Vocabulary/ORBvoc.txt Examples/RGB-D/TUM1.yaml YOUR_PATH/rgbd_dataset_freiburg1_desk YOUR_PATH/rgbd_dataset_freiburg1_desk/association.txt
```
...
```
python2 evaluation/evaluate_ate_scale.py YOUR_PATH/rgbd_dataset_freiburg1_xyz/groundtruth.txt CameraTrajectory.txt --verbose --verbose2 --plot wxyz_rgbd.pdf
...
evo_traj tum --ref groundtruth.txt ORB-SLAM2.txt ours.txt -va -as --plot --save_plot plt.png --save_as_tum
```
